...
interface GetTransactionSummaryUseCase {
    fun execute(filter: TransactionFilter): Either<TransactionError, TransactionSummaryResult>
}

class GetTransactionSummaryInteractor(
    private val repository: TransactionRepository
) : GetTransactionSummaryUseCase {
    override fun execute(filter: TransactionFilter): Either<TransactionError, TransactionSummaryResult> =
